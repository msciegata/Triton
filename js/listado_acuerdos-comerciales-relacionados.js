jQuery(document).ready(function ($) {
    jQuery("#rowed2").jqGrid({
        url: 'listado_acuerdos-comerciales-relacionados.json',
        datatype: "json",
        colNames: ['IDENTIFICADOR', 'COMPRADOR', 'PRODUCTO', 'CANTIDAD', 'INCOTERM', 'ESTADO', ''],
        colModel: [
            {name: 'campo1', sortable: false, title: false, width: '150'},
            {name: 'campo2', sortable: false, title: false, width: '180'},
            {name: 'campo3', sortable: false, title: false, width: '300'},
            ...
            {name: 'campo7', sortable: false, title: false, width: '0'},
        ],
        rowNum: 5,
        rowList: [5, 10, 15],
        pager: '#prowed2',
