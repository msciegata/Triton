jQuery(document).ready(function ($) {
    jQuery("#rowed2").jqGrid({
        ...
        colModel: [
            ...
            {name: 'campo3', sortable: false, title: false, width: '240'}, 
            ...
            {name: 'campo7', sortable: false, title: false, width: '135'}, 
        ...
        gridComplete: function () {
            ...
            for (var i = 0; i < ids.length; i++) {
                ...
                duplicar = "<span class='fa fa-files-o btn-acciones' type='button' value='E' />";
