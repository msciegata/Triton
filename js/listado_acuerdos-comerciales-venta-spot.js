jQuery(document).ready(function ($) {
    jQuery("#rowed2").jqGrid({
        ...
        datatype: "json",
        colNames: ['NUMERO IDENTIFICADOR DEL ACUERDO', 'PROCEDENCIA', 'COMPRADOR', 'FECHA DE CIERRE', 'MONTO ESTIMADO Y DIVISA', 'NOMBRE DEL PRODUCTO', 'CANTIDAD / VOLUMEN', 'ESTADO DEL ACUERDO', 'ESTADO DE PAGO', ''],
        colModel: [
            ...
            {name: 'campo5', sortable: false, title: false, width: '115'}, 
            {name: 'campo6', sortable: false, title: false, width: '145'}, 
            {name: 'campo7', sortable: false, title: false, width: '100'}, 
