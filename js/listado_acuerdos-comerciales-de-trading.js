jQuery(document).ready(function ($) {
    jQuery("#rowed2").jqGrid({
        url: 'listado_acuerdos-comerciales-de-trading.json',
        datatype: "json",
        colNames: ['ID', 'RELACIONADO CON ACUERDO DE COMPRA', 'RELACIONADO CON ACUERDO DE VENTA', 'PRODUCTO', 'CANTIDAD', 'ESTADO', ''],
        colModel: [
