...
<html lang="es">
	<head>
        ...
        <link rel="stylesheet" href="js/plugins/fine-uploader/fine-uploader-gallery.css">            
        </head>
	<body>
		...
		$("input, textarea").blur(functionLabelPosition);
         ...
         <div class="qq-uploader-selector qq-gallery" qq-drop-area-text="">
        ...
        <ul class="qq-upload-list-selector qq-upload-list" role="region" aria-live="polite" aria-relevant="additions removals">
            <li>
                ...
                <button type="button" class="qq-upload-cancel-selector qq-upload-cancel well-trash-button">
