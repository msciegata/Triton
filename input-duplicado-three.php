						...
						<div class="card">
							...
							<div class="card-body">
								<div class="col-lg-6">
									...
									<div class="input-group">
										<select id="mov-triton" class="select-buscador" style="width: 100%">
											<option value=""></option>
									...
									<div class="input-group duplicated d-three">
										<select name="fletador" id="fletador">
											<option value=""></option>
											<option value="v1" selected>YPF S.A.</option>
										...
										<div class="well">
											...
											<div class="well-body">
												<div class="row">
													<div class="col-lg-6">
														<div class="input-group">
															<input class="input-date" id="fecha-inicio" type="text" name="fecha-inicio">
															<span class="fa fa-calendar" aria-hidden="true"></span>
													...
													<div class="col-lg-6">
														<div class="input-group">
															<input id="horario-inicio" type="text" class="form-control input-small timepicker">
										...
										<div class="well">
											...
											<div class="well-body">
												<div class="row">
													<div class="col-lg-6">
														<div class="input-group">
															<input id="fecha-fin" class="input-date" type="text" name="fecha-fin">
															<span class="fa fa-calendar" aria-hidden="true"></span>
													...
													<div class="col-lg-6">
														<div class="input-group">
															<input id="horario-fin" type="text" class="form-control input-small timepicker">
															<span class="fa fa-clock-o" aria-hidden="true"></span>
								...
								<div class="col-lg-6">
									<div class="input-group duplicated d-three">
										<select id="armador" name="armador">
											<option value=""></option>
											<option value="v1" selected>Nombre Opción 1</option>
									...
									<div class="input-group duplicated d-three">
										<select id="broker" name="broker">
											<option value=""></option>
											<option value="v1" selected>Broker 1</option>
											<option value="v2">Broker 2</option>
										</select>
										<label for="broker">Broker<span>*</span></label>
										<p><span class="fa fa-warning"></span> Este es un campo duplicado.</p>
									</div>
									<div class="input-group duplicated d-three">
										<select id="buque" name="buque">
											<option value=""</option>
											<option value="v1" selected>Buque Papa Juan Pablo II</option>
											...
											<div class=" laytime">
												...
												<div class="tab-content">
													<div role="tabpanel" class="tab-pane fijo active" id="fijo">
														<div class="input-group">
															<input id="tiempo-fijo" type="text" class="form-control input-small timepicker">
															<span class="fa fa-clock-o" aria-hidden="true"></span>
													...
													<div role="tabpanel" class="tab-pane calculado" id="calculado">
														<div class="col-lg-6">
															<div class="input-group">
																<input id="caudal-volumen" type="text" name="caudal-volumen">
														...
														<div class="col-lg-3">
															<div class="input-group">
																<select id="UOM" name="UOM">
																	<option value=""></option>
																	<option value="v1" selected>TN</option>
														...
														<div class="col-lg-3">
															<div class="input-group">
																<input id="tiempo-calculado" type="text" class="form-control input-small timepicker">
																<span class="fa fa-clock-o" aria-hidden="true"></span>
											...
											<div class="well">
												...
												<div class="well-body">
													<div class="row">
														<div class="col-lg-8">
															<div class="input-group">
																<input id="cantidad" type="text" name="cantidad" value="12.098.473">
														...
														<div class="col-lg-4">
															<div class="input-group">
																<select id="divisa" name="divisa">
																	<option value=""></option>
																	<option value="v1" selected>ARS</option>
							...
							<div class="card-body">
								<div class="col-lg-6 calculator" >
									<div class="row">
										<div class="col-lg-4">
											<div class="input-group">
												<select id="tipo-precio" name="tipo-precio">
													<option value=""></option>
													<option value="v1" selected>Unitario</option>
										...
										<div class="col-lg-3">
											<div class="input-group">
												<input id="precio" type="text" name="precio" value="12.098.473">
										...
										<div class="col-lg-3">
											<div class="input-group">
												...
												<input id="ws" type="text" name="ws" disabled>
									...
									<div class="row">
										<div class="col-lg-6">
											<div class="input-group">
												<input id="cantidad-bl" type="text" name="cantidad-bl" value="19.870.734">
										...
										<div class="col-lg-3">
											<div class="input-group">
												<input id="overage" type="text" name="overage" value="20">
									...
									<div class="row">
										<div class="col-lg-4">
											<div class="input-group">
												<input id="cant-min" type="text" name="cant-min" value="100">
												<label for="cant-min">Cantidad mínima</label>
											</div>
										</div>
										<div class="col-lg-4">
											<div class="input-group">
												<input id="add-comiss" type="text" name="add-comiss" value="Information entered">
