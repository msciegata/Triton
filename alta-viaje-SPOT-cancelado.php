						...
						<div class="card">
							<div class="card-header">
								...
								<div class="state">
									...
									<div class="cancel">
										<h5><span class="fa fa-close"></span>CANCELADO</h5>
									</div>
								</div>
							</div>
							<div class="card-body">
								...
								<div class="col-lg-6 results">
									...
									<!-- Cuando se presiona el botón cancelar, debe "redirigir" al anchor point #trip-canceled para que el usuario visualice el mensaje de alerta. -->
									<button class="btn btn-danger hidden">CANCELAR VIAJE</button>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card">
							<div class="card-header">
								<div class="card-title">
									...
									<!-- Cuando no haya costos o ingresos asociados, agregar la clase hidden al siguiente div -->
									<div class="add">
